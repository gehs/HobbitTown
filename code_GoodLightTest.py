"""LED Color Order Diagnostic Test for ESP32-S3 CircuitPython.

Diagnoses the correct color order for mixed LED types in sky strip.
Tests different color mappings for SK6812 section (pixels 19-109).
"""
...
STREAM_PIXEL_COUNT = 70  # Not used in this test but defined for completeness
BRIGHTNESS = 0.25

# Explicit pin mapping for this diagnostic
SKY_PIN = config.NEOPIXEL_SKY_PIN        # GPIO4
GROUND_PIN = config.NEOPIXEL_GROUND_PIN  # GPIO5
STREAM_PIN = config.NEOPIXEL_STREAM_PIN  # GPIO6 (not used in this test)
...
print(f"Configured ground pin: GPIO{GROUND_PIN} (should be 5)")
print(f"Configured stream pin: GPIO{STREAM_PIN} (should be 6, not used in this test)")
